...
type RestOf<T extends IMovimiento | NewMovimiento> = Omit<T, 'fechaMovimiento' | 'fechaRegistro' | 'fechaActualizacion'> & {
...
export class MovimientoService {
  ...
  protected convertDateFromClient<T extends IMovimiento | NewMovimiento | PartialUpdateMovimiento>(movimiento: T): RestOf<T> {
    return {
      ...
      fechaRegistro: movimiento.fechaRegistro?.toJSON() ?? null,
      fechaActualizacion: movimiento.fechaActualizacion?.toJSON() ?? null,
    };
  }
  ...
  protected convertDateFromServer(restMovimiento: RestMovimiento): IMovimiento {
    return {
      ...
      fechaRegistro: restMovimiento.fechaRegistro ? dayjs(restMovimiento.fechaRegistro) : undefined,
      fechaActualizacion: restMovimiento.fechaActualizacion ? dayjs(restMovimiento.fechaActualizacion) : undefined,
    };
  }
