...
import { sampleWithRequiredData } from '../presupuesto.test-samples';
...
describe('Presupuesto Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.presupuestos()[0]).toEqual(expect.objectContaining({ id: 6207 }));
  });

  describe('trackId', () => {
    it('should forward to presupuestoService', () => {
      const entity = { id: 6207 };
      jest.spyOn(service, 'getPresupuestoIdentifier');
      const id = comp.trackId(entity);
      expect(service.getPresupuestoIdentifier).toHaveBeenCalledWith(entity);
